                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="dashboard-stat2 ">
                                ...
                                @else
                                    <div class="row">
                                        <span class="section_title col-lg-9 col-sm-12 col-xs-12" style="margin-top:4%;color:#B71D2A;font-size:24px">Average Video</span>
                                    ...
                                    <div class="row">
                                        <span class="section_title col-lg-9 col-sm-12 col-xs-12" style="margin-top:4%;color:#B71D2A;font-size:24px">Average Engagement</span>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4 averageStat">
                                    ...
                                    <div class="row">
                                        <span class="section_title col-lg-9 col-sm-12 col-xs-12" style="margin-top:4%;color:#B71D2A;font-size:24px">Average Channel</span>
                                    </div>
                                    <div class="row">
